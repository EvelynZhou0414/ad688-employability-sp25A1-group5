...
fig = px.bar(top_20_industries, title="Job Postings by Industry")
fig.show()
```
...
fig = px.box(df_filtered, x="NAICS_2022_6_NAME", y=salary_col, 
             title="Salary Distribution by Industry", points="outliers")
